...
def kaffpa(
    ...
    try:
        ...
        if partition:
            kwargs["input_partition"] = partition
...
if __name__ == "__main__":
    ...
    def init():
        ...
        parser.add_argument('-p', '--initial_partition', type=str, 
                        help='Partition to improve. If undefined, partition made from scratch')
    ...
    print(kaffpa(
        ...
        output=args.output, 
        seed=args.seed,
        E = args.evolutionary[0] if args.evolutionary else None,
        config = args.config,
